...
unlocked to sign the Marketcoin-Qt.app bundle.
...
allowing somebody to distribute a Marketcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the marketcoin-qt.exe file inside the installer had not been tampered with.
